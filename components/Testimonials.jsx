...
const Testimonials = ({ children, client, className }) => {
  return (
    <div
      className={clsx(
        "relative isolate bg-brand-blush-light/30 py-16 sm:py-28 md:py-32",
        className
      )}
    >
      <GridPattern
      ...
      <Container>
        <FadeIn>
          <figure className="mx-auto max-w-4xl">
            <blockquote className="relative font-display text-3xl font-medium tracking-tight text-brand-espresso sm:text-4xl">
